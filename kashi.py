...
##### LOGO #####
logo = """                              
 \033[1;93m_  __    _     ____   _   _  ___ 
\033[1;93m| |/ /   / \   / ___| | | | ||_ _|
\033[1;93m| ' /   / _ \  \___ \ | |_| | | | 
\033[1;93m| . \  / ___ \  ___) ||  _  | | | 
\033[1;93m|_|\_\/_/   \_\|____/ |_| |_||___|

\033[1;91m--> WhatsApp number +923062045786

\033[1;92m--> FACEBOOK :- Kashi

\033[1;93m--> YOUTUBE :- Kashi Teaches 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Kashi
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_crack():
	...
	p.map(main, id)
	print "▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤▤"
	print "  Written By Qaiser" #Dev:Kashi
	print '\033[1;94mProcess Has Been Completed \033[1;94m....'
        print '\033[1;92mType (python2 kashi.py) New Fb Start Cloning\033[1;92m....'
...
def brute():
    ...
    try:
        ...
        try:
            ...
            passw = raw_input('\x1b[1;95mWordlist \x1b[1;95m(Type--> kashi.list) \x1b[1;95m: \x1b[1;95m')
            total = open(passw, 'r')
